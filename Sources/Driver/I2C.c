...
void SendI2C_char(char *data){
    while(I2C_B0.USIC_Status_Register_I2C.cfg_UCBBUSY);
    I2C_B0.USIC_TransmitBuffer_Register = *data;
};
*/
...
void I2cTransmitInit(unsigned char slaveAddress)
{
    ...
    UCB0CTL1    = UCSSEL_2 + UCSWRST;              // Use ACLK, keep SW reset
    UCB0BR0     = PRESCALE;                        // Set prescaler - ACLK = ~1048Khz/12 = 87.3Khz
    UCB0BR1     = 0;
